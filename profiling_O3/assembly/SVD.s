...
.L3:
	...
	vmla.f32	s3, s5, s13
	vmla.f32	s27, s18, s7
	vmla.f32	s24, s18, s10
	vmla.f32	s20, s17, s7
	vmla.f32	s4, s0, s7
	vmla.f32	s23, s0, s8
	vldr.32	s7, [fp, #60]
	vmla.f32	s1, s17, s9
	vmla.f32	s22, s17, s10
	vmla.f32	s21, s0, s9
	vmla.f32	s19, s0, s10
	vmla.f32	s27, s6, s12
	vmla.f32	s24, s6, s15
	...
	vmov.f32	s10, s16
	vmov.f32	s11, s16
	vmla.f32	s10, s13, s12
	vmla.f32	s11, s13, s25
	vmov.f32	s13, s16
	vmla.f32	s13, s15, s12
	vmov.f32	s12, s13
	vmov.f32	s13, s16
	vmla.f32	s3, s22, s2
	vmla.f32	s13, s15, s25
	vldr.32	s22, [sp, #444]
	vldr.32	s15, [sp, #460]
	vmla.f32	s6, s22, s24
	vmla.f32	s7, s15, s24
	vmla.f32	s8, s22, s23
	vmla.f32	s9, s15, s23
	vmla.f32	s10, s22, s21
	vmla.f32	s11, s22, s20
	vmla.f32	s12, s15, s21
	vmla.f32	s13, s15, s20
	vstr.32	s17, [sp, #288]
	vldr.32	s15, [sp, #464]
	vldr.32	s17, [sp, #448]
	vmla.f32	s7, s15, s19
	...
	vmla.f32	s28, s23, s19
	vmla.f32	s27, s13, s14
	vmla.f32	s26, s13, s15
	vmla.f32	s25, s13, s21
	vmla.f32	s24, s13, s19
	vmov.f32	s23, s16
	vmov.f32	s13, s16
